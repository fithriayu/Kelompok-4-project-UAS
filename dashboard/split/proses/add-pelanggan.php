...
if (isset($_POST['btn_save'])) {
  ...
  if ($cek > 0) {
    ...
    header("location:?hal=add-pelanggan&pesan=username"); //munculkan pesan error
  } else {
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
      ...
      if ($ukuran < 5044070) { // dicek, filenya harus kurang dari 1mb
        ...
        header("location:?hal=add-pelanggan&pesan=ukuran");
      }
    } else {
      // jika ekstensi file salah
      header("location:?hal=add-pelanggan&pesan=ekstensi");
    }
  }
}
